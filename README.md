...
Four feature extractors are combined to conduct near-duplicate video detection tasks, which are:

1. Color distribution in the HSV color space.
2. Color coherence.
3. Edge orientation.
4. The height and width of bounding box.

This combination has been proved to have the highest accuracy in all the combinations of four feature extractors.
...
2. In Main -> C/C++ Application: entering (the location of the executable of the project), e.g., Debug/Hist\_Nest\_parallel\_4.
