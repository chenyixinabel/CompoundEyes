...
Two feature extractors are involved in this branch to conduct near-duplicate video detection tasks, which are:
...
2. In Main -> C/C++ Application: entering (the location of the executable of the project), e.g., Debug/Hist\_Nest\_parallel\_2.
