...
Five feature extractors are combined to conduct near-duplicate video detection tasks, which are:
...
This combination has been proved to have the highest accuracy in all the combinations of five extractors.

All the computations are running in parallel in this branch.
...
2. In Main -> C/C++ Application: entering (the location of the executable of the project), e.g., Debug/Hist\_Nest\_parallel\_5.
