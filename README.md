...
The number of threads is adjustable in this branch, including how many feature extractors could run in parallel, and how many threads are disposable for each one.
...
2. In Main -> C/C++ Application: entering (the location of the executable of the project), e.g., Debug/Hist\_Nest\_parallel\_thd\_num.
3. In Arguments -> Program arguments: entering (the location of the training video set) (the location of the groundtruth file of the training videos) (the location of the testing video set) (the location of the groundtruth file of the testing videos) (the number of feature extractors allowed running in parallel) (the number of threads for hsv extractor) (the number of threads for cc extractor) (the number of threads for sp extractor) (the number of threads for eo extractor) (the number of threads for bb extractor) (the number of threads for tex extractor) (the number of threads for op extractor) (not used), each argument occupies the whole line.
