...
3. Properties -> C/C++ Build -> Settings -> GCC C++ Linker -> Libraries -> Libraries (-l): Add opencv\_core gomp opencv\_imgproc opencv\_highgui opencv\_ml opencv\_video opencv\_features2d opencv\_calib3d opencv\_objdetect opencv\_contrib opencv\_legacy opencv\_flann opencv\_imgcodecs.
...
5. Note that once the project has been downloaded to your computer for the first time, or moved to another machine, the data structures conf\_file in pre\_proc\_aux\_funcs.cpp, feature\_vector\_folder, and label\_vector\_folder in emit\_ques\_aux\_funcs.cpp should be changed accordingly to your directory hierarchy, then the project should be re-compiled.

An example for step 3 is:

/home/yixin/dataset/CC_WEB_VIDEO/Test_s_0.1_p_0.5/Test_v1/1_train/

/home/yixin/dataset/CC_WEB_VIDEO/Test_s_0.1_p_0.5/Test_v1/groundtruth/GT_new_1_train.txt

/home/yixin/dataset/CC_WEB_VIDEO/Test_s_0.1_p_0.5/Test_v1/1_test/

/home/yixin/dataset/CC_WEB_VIDEO/Test_s_0.1_p_0.5/Test_v1/groundtruth/GT_new_1_test.txt.
