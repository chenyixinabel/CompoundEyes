...
char *func_name_array[] = {"hsv_color_dist", "color_coherence_dist", "spatial_pattern_dist", "edge_orient_dist"\
		, "bounding_box_dist", "texture_dist"};
char *suffix_array[] = {"_vectors.txt", "_labels.txt"};
char feature_vector_folder[] = "/home/yixin/workspace/Hist_Nest_parallel_6/Vector_files/";
char label_vector_folder[] = "/home/yixin/workspace/Hist_Nest_parallel_6/Label_files/";
